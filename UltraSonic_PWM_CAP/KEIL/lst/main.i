...
void PWMA_IRQHandler(void)
{
    ...
    u32CapIntFlag1 = ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR0;

     
    if(u32CapIntFlag1 & (1ul << 4))
    {
        ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CCR0 &= (0x000F000F | (1ul << 4));
    }
}
...
void CalPeriodTime(PWM_T *PWM, uint32_t u32Ch)
{
    ...
    PWM_ClearCaptureIntFlag(PWM, u32Ch, ((1ul << 2)));
    ...
    while(u32i < 4)
    {
        ...
        PWM_ClearCaptureIntFlag(PWM, u32Ch, ((1ul << 2)) | ((1ul << 1)));

         
        u32Count[u32i++] = (*((volatile uint32_t *) ((((uint32_t)&((PWM)->CFLR0)) + (u32Ch) * 8))));

         
        while(PWM_GetCaptureIntFlag(PWM, u32Ch) < 1);

         
        PWM_ClearCaptureIntFlag(PWM, u32Ch, ((1ul << 1)));

         
        u32Count[u32i++] = (*((volatile uint32_t *) ((((uint32_t)&((PWM)->CRLR0)) + (u32Ch) * 8))));
    }
...
void SYS_Init(void)
{
    ...
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPF_MFP &= ~((1UL<<0) | (1UL<<1));
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPF_MFP |= (1UL<<0) | (1UL<<1);
    ...
    CLK_SetModuleClock(((((1) & 0x03) << 30)|(((20) & 0x1f) << 0)| (((1) & 0x03) << 28)|(((3) & 0x07) << 25)|(((28) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)), (0x0UL<<28) | (0x0UL<<8), 0);
    CLK_SetModuleClock(((((1) & 0x03) << 30)|(((21) & 0x1f) << 0)| (((1) & 0x03) << 28)|(((3) & 0x07) << 25)|(((30) & 0x1f) << 20)| (((0x0) & 0x03) << 18)|(((0x0) & 0xff) << 10)|(((0x0) & 0x1f) << 5)), (0x0UL<<30) | (0x0UL<<9), 0);
...
int32_t main(void)
{
    ...
    while(1)
    {
        ...
        PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x1, 250, 30);

         
        PWM_EnableOutput(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x2);

         
        PWM_Start(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x2);
        ...
        PWM_ConfigCaptureChannel(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x0, 166, 0);

         
        PWM_EnableCaptureInt(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x0, ((1ul << 2)));

         
        NVIC_EnableIRQ((IRQn_Type)(PWMA_IRQn));

         
        PWM_Start(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x1);

         
        PWM_EnableCapture(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x1);

         
        while(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PDR0 == 0);

         
        CalPeriodTime(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x0);
        ...
        PWM_Stop(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x2);

         
        while(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PDR1 != 0);

         
        PWM_ForceStop(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x2);

         
        PWM_DisableOutput(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x2);
        ...
        PWM_Stop(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x1);

         
        while(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PDR0 != 0);

         
        PWM_ForceStop(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x1);

         
        PWM_DisableCapture(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x1);

         
        PWM_ClearCaptureIntFlag(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x0, ((1ul << 2)));
    }
}
