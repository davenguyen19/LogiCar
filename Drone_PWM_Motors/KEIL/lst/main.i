...
void SYS_Init(void)
{
    ...
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP &= ~((1UL<<12) | (1UL<<13) | (1UL<<14) 	| (1UL<<15));
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP |= (1UL<<12) | (1UL<<13) | (1UL<<14) | (1UL<<15);
...
void Delay2(void) {
	...
	int x = 30;
		...
		PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x0, 150, i); 
	  PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x1, 150, i);	
		PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x2, 150, i); 
		PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x3, 150, i); 
			i++;
		Delay();
		}
		return;
...
int main()
{
    ...
    printf("+--------------------------------------------------------------+\n");
		...
		PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x0, 50, 0); 
	  PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x1, 50, 0);	
		PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x2, 50, 0); 
		PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x3, 50, 0); 
		
			PWM_EnableOutput(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x1);
			PWM_EnableOutput(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x2);
			PWM_EnableOutput(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x3);
			PWM_EnableOutput(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x4); 
			PWM_EnableOutput(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x8); 


	  	PWM_Start(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x1);
	  	PWM_Start(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x2);
	  	PWM_Start(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x3); 
	  	PWM_Start(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x4);
	  	PWM_Start(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x8); 
		...
		PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x0, 150, 0); 
	  PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x1, 150, 0);	
		PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x2, 150, 0); 
		PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x3, 150, 0); 
