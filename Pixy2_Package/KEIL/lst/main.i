...
uint32_t g_au32SourceData[4];
uint32_t g_au32DestinationData[4];
...
int main(void)
{
	...
	for (i = 0; i < 4; i++){
        ...
        while(1)
        {
            ...
            ((((SPI_T *) ((( uint32_t)0x40000000) + 0x30000)))->TX[0] = (g_au32SourceData[u32Data[i]]));
             
            ((((SPI_T *) ((( uint32_t)0x40000000) + 0x30000)))->CNTRL |= (1ul << 0));
             
            while(( ((((SPI_T *) ((( uint32_t)0x40000000) + 0x30000)))->CNTRL & (1ul << 0))>>0 ));
             
            g_au32DestinationData[u32Data[i]] = ((((SPI_T *) ((( uint32_t)0x40000000) + 0x30000)))->RX[0]);
						printf("%d\n",((((SPI_T *) ((( uint32_t)0x40000000) + 0x30000)))->RX[0]));
            u32Data[i]++;
            if(u32Data[i] > 0)
                break;
        }
...
void SYS_Init(void)
{
    ...
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPC_MFP |= (1UL<<0) | (1UL<<1) | (1UL<<2) | (1UL<<3);
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->ALT_MFP &= ~((1UL<<5) | (1UL<<6) | (1UL<<7) | (1UL<<8));
