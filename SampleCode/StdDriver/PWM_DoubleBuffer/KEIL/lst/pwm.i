                                  ...
                                  uint32_t u32CaptureEdge)
{
    ...
    uint32_t u32PWMClkTbl[8] = {(12000000UL), 0, 0, (22118400UL), 0, 0, 0, (10000UL)};
...
void PWM_EnablePDMA(PWM_T *pwm, uint32_t u32ChannelMask, uint32_t u32RisingFirst)
{
    ...
    for(i = 0; i < (4); i ++)
    {
        if(u32ChannelMask & (1 << i))
        {
            (pwm)->CAPPDMACTL = ((pwm)->CAPPDMACTL & ~((1ul << 3) << (i * 8))) |                                 (((u32RisingFirst << 3) |                                   (3ul << 1) | (1ul << 0)) << (i * 8));
