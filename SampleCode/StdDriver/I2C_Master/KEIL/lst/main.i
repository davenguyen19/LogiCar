...
void SYS_Init(void)
{
    ...
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPF_MFP &= ~((1UL<<2) | (1UL<<3));
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPF_MFP |= ((1UL<<2) | (1UL<<3));
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->ALT_MFP1 &= ~((0x3UL<<24) | (0x3UL<<26));
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->ALT_MFP1 |= ((0x2UL<<24) | (0x2UL<<26));
}
