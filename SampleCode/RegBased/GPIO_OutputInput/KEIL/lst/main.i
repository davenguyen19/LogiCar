...
int main(void)
{
    ...
    (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1))) + ((4)<<2)))) = 1;
    if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1))) + ((5)<<2)))) == 1)
    {
        i32Err = 1;
    }
    ...
    ((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040))->PMD = (((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040))->PMD & (~(0x3ul << 8))) | (0x3UL << 8);
    ((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040))->PMD = (((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040))->PMD & (~(0x3ul << 10))) | (0x3UL << 10);
