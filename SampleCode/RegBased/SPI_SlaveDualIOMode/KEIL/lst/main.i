...
uint32_t g_au32SourceData[21];
uint32_t g_au32DestinationData[21];
...
int main(void)
{
    ...
    ((((SPI_T *) ((( uint32_t)0x40000000) + 0x30000)))->CNTRL2 = ((((SPI_T *) ((( uint32_t)0x40000000) + 0x30000)))->CNTRL2 & (~(1ul << 12))) | (1ul << 13));
    ...
    for(u32TxDataCount = 0; u32TxDataCount < 21; u32TxDataCount++)
    {
    ...
    while(u32RxDataCount < 21)
    {
         
        if((((((SPI_T *) ((( uint32_t)0x40000000) + 0x30000)))->STATUS & (1ul << 24))>>24) == 0)
					printf("pass1");
            g_au32DestinationData[u32RxDataCount++] = ((((SPI_T *) ((( uint32_t)0x40000000) + 0x30000)))->RX[0]);  
    }

     
    printf("Received data:\n");
    for(u32RxDataCount = 0; u32RxDataCount < 21; u32RxDataCount++)
    {
    ...
    ((((SPI_T *) ((( uint32_t)0x40000000) + 0x30000)))->CNTRL2 |= ((1ul << 13) | (1ul << 12)));
    u32TxDataCount = 0;
    u32RxDataCount = 0;
    printf("< Stage 2 >\n");
    ...
    while(u32RxDataCount < 21)
    {
        ...
        if(((((((SPI_T *) ((( uint32_t)0x40000000) + 0x30000)))->STATUS & (1ul << 27))>>27) == 0) && (u32TxDataCount < 21))
				printf("WTF");
            ((((SPI_T *) ((( uint32_t)0x40000000) + 0x30000)))->TX[0] = (g_au32SourceData[u32TxDataCount++]));  
...
void SYS_Init(void)
{
    ...
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0 = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0 & (~(7ul << 0))) | (0x0UL<<0);

     
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (~((3ul << 24) | (1ul << 4)))) | ((0x0UL<<24) | (0x1UL<<4));

     
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK = (1ul << 16) | (1ul << 12);
    ...
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPB_MFP &= ~((1UL<<0) | (1UL<<1) | (1UL<<12));
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPB_MFP |= ((1UL<<0) | (1UL<<1) | (1UL<<12));
		
		((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPC_MFP &= ~((1UL<<2) | (1UL<<3) | (1UL<<1) | (1UL<<0));
		((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPC_MFP |=  ((1UL<<2) | (1UL<<3) | (1UL<<1) | (1UL<<0));
    ...
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->ALT_MFP &= ~((1UL<<2) | (1UL<<3) | (1UL<<1) | (1UL<<0));
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->ALT_MFP |=  ((1UL<<2) | (1UL<<3) | (1UL<<1) | (1UL<<0));
}
...
void SPI_Init(void)
{
    ...
    ((SPI_T *) ((( uint32_t)0x40000000) + 0x30000))->CNTRL = (1ul << 21) | (1ul << 18) | (1ul << 2);
     
    ((SPI_T *) ((( uint32_t)0x40000000) + 0x30000))->SSR = (1ul << 4);
     
    ((SPI_T *) ((( uint32_t)0x40000000) + 0x30000))->DIVIDER = 0;
}
